 ...
 */
#define OMPI_DATATYPE_MPI_LONG                    0x30
#define OMPI_DATATYPE_MPI_UNSIGNED_LONG           0x31
 ...
 */
#define OMPI_DATATYPE_MPI_SHORT_FLOAT             0x32
#define OMPI_DATATYPE_MPI_C_SHORT_FLOAT_COMPLEX   0x33
