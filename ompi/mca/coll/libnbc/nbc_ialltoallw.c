                              ...
                              struct mca_coll_base_module_2_3_0_t *module, bool persistent)
{
  ...
  enum { NBC_ALLTOALLW_LINEAR,  NBC_ALLTOALLW_PAIRWISE , NBC_ALLTOALLW_INPLACE} alg;
  ...
  if (alg != NBC_ALLTOALLW_INPLACE && sendcounts[rank] != 0) {
